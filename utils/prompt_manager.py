...
from models.receipt import Recipe
from utils.web_utils import get_website_context
...
class OpenaiApiManager:
    ...
    def get_recipe(self, website_url: url, gpt_model: str = "gpt-4o-mini") -> Recipe:
    ...
    def __process_prompt(self, website_url: url):
